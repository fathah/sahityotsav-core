...
const NPMInstall = ({hasNodeModules,instanceid}:{hasNodeModules:boolean,instanceid:string}) => {
    ...
    return (
        <div className="my-5 p-5 ring-2 ring-red-700 bg-red-50 text-red-700 flex justify-between">
            <div>
            ...
            <div>
            <button className="btn my-4 bg-red-700 text-white flex items-center gap-x-2 disabled:bg-gray-500"
                        onClick={install}
                        disabled={installing}
                    >
                        {installing? <>
